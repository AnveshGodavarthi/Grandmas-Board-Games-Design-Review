...
assert.match(progress, /Cloud-Linux diagnostics advanced the database gate, but the current exact-head pipeline has not started and the final repository gate remains open\./);
...
assert.match(progress, /Verification boundary:<\/strong> Focused local contract and Block 06 checks passed, and independent review found no open P0\/P1 issue in the reviewed changes\./);
...
const expectedVisibleText = "Grandma's Board Games · Build Roadmap Skip to build roadmap G Grandma's Board Games Design review Build status Roadmap Updated 9 September 2026 Next milestone: verify and merge Blocks 05–06 Cloud-Linux diagnostics advanced the database gate, but the current exact-head pipeline has not started and the final repository gate remains open. Verification 00 Storyboard and journey Approved product and visual contract. Complete 01 Expo foundation Core experience foundation. Complete 02 Intro and board formation Authored first arrival and live board handoff. Complete 03 Ashta Chamma 2–4 player local rules loop, result and rematch. Complete 04 Navakankari Two-player local board, mills, capture and result. Complete 05 Character system Repository and browser checkpoint complete; rights, cultural and physical-device gates remain. External gates 06 Ownerless multiplayer Milestones 06.0–06.7 are on the integration branch. A partial cloud-Linux diagnostic passed database bootstrap and loaded the legacy-upgrade fixture; the exact repository, provider, carrier, and device gates remain open. Candidate 07 Puli Meka Third-game expansion follows the first stable two-game launch. Post-launch 08 Launch quality Accounts, privacy, safety, operations, native experience and release-candidate closeout. Planned 09 First store release Signing, listings, beta, submission, controlled launch and initial watch. Planned Current checkpoint: Blocks 05 and 06 are feature-complete integration candidates; the repository verification gate remains open. Character work is browser-accepted; both launch games now have the ownerless multiplayer journey. Rights, cultural, provider, carrier and physical-device evidence remain open. Verification boundary: Focused local contract and Block 06 checks passed, and independent review found no open P0/P1 issue in the reviewed changes. An earlier diagnostic cloud-Linux run passed the fresh-database preflight, bootstrap, and earlier upgrades, then loaded the legacy-upgrade fixture; it stopped at the next database reconciliation boundary, so the database gate remains open. The current exact-head pipeline, dependency-backed application gate, and hosted rendered review remain pending; no merge, native, or production-readiness result is claimed. Path to first launch: close the open Blocks 05–06 evidence, complete Block 08 quality and compliance, then execute Block 09 beta, store submission, controlled release and the initial 72-hour watch. Puli Meka follows stabilization. Owner-facing build roadmap";
